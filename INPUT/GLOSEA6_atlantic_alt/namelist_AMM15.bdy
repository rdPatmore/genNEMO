...
!  grid information 
!------------------------------------------------------------------------------
   sn_src_hgr = '/gws/nopw/j04/jmmp/MASS/GloSea6/Grid/mesh_mask_glosea6_amm15_subset.nc'
   sn_src_zgr = '/gws/nopw/j04/jmmp/MASS/GloSea6/Grid/mesh_mask_glosea6_amm15_subset.nc'
   sn_dst_hgr = '/gws/nopw/j04/jmmp/public/AMM15/DOMAIN_CFG/GEG_SF12.nc'
   sn_dst_zgr = '/gws/nopw/j04/jmmp/MASS/GloSea6/Grid/mesh_mask_glosea6_amm15_subset.nc'
!   sn_dst_zgr = './inputs_dst.ncml'
   sn_src_msk = '/gws/nopw/j04/jmmp/MASS/GloSea6/Grid/mesh_mask_glosea6_amm15_subset.nc'
...
!------------------------------------------------------------------------------
   ...
   sn_dst_dir = '../../OUTPUT/GLOSEA6_atlantic_alt/'
